...
describe('mozilla-ie8-utils.js', function() {
    ...
    describe('triggerIEDownload', function () {
        ...
        it('should open a popup for IE < 9', function () {
            ...
            Mozilla.IE8Utils.triggerIEDownload('foo', userAgent);
    ...
    describe('initDownloadLinks', function () {
        ...
        it('should call triggerIEDownload when clicked', function () {
            spyOn(Mozilla.IE8Utils, 'triggerIEDownload');
            Mozilla.IE8Utils.initDownloadLinks();
            $('.download-link').trigger('click');
            expect(Mozilla.IE8Utils.triggerIEDownload).toHaveBeenCalled();
        });
